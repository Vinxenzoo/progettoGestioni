...
public class HomePage extends JFrame
{
    private Controller curr;
        public HomePage(Controller currcontroller) {
            ...
            mainPanel.add(new JLabel("Benvenuto nella Home Page!", SwingConstants.CENTER), BorderLayout.NORTH);
        ...
        private JPanel createCenterPanel() {
            ...
            JButton button3 = createButtonWithShadow("Area Personale partecipante");
